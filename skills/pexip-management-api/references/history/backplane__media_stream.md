...
**Endpoint:** `/api/admin/history/v1/backplane/<id>/media_stream/`

## Fields

| Field | Type | Description |
|---|---|---|
| `backplane` | `backplane` (related resource) | The backplane for the media stream. |
...
| `tx_resolution` | string | The resolution of the stream received from the remote Conferencing Node. |
